        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Brands = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Computers_Categories_CategorieId",
                        column: x => x.CategorieId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Computers_Sizes_SizesId",
                        column: x => x.SizesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Computers_CategorieId",
                table: "Computers",
                column: "CategorieId");

            migrationBuilder.CreateIndex(
                name: "IX_Computers_SizesId",
                table: "Computers",
                column: "SizesId");
